...
class Facility:
    ...
    def get_carousel_pos(self, carousel_radius: float, pos_high: tuple):
        ...
        return tuple((x,y,pos_high_here[2], pos_high_here[3], pos_high_here[4], pos_high_here[5]))
...
Flip_stand_gripper_bottomup_tube_bottomup = \
    [i for i in facilities if i.name == 'flip_stand_gripper_bottomup_tube_bottomup'][0]
Flip_stand_gripper_topdown_tube_bottomup = \
    [i for i in facilities if i.name == 'flip_stand_gripper_topdown_tube_bottomup'][0]
