...
def process_run_by_shortname(run_shortname):
    ...
    for index, row in concentrations_df.iterrows():
        substrate_concentration_before_reaction = concentrations_df.at[index, f'c#{substrate_name}']
        product_concentration = concentrations_df.at[index, f'pc#{product_name}']
        product_concentration = max(product_concentration, 0)
        substrate_concentration_after_reaction = concentrations_df.at[index, f'pc#{byproduct_name}']
