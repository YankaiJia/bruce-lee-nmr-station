...
plate_folder = data_folder + 'nanodrop-spectrometer-measurements/reference_for_simple_SN1/2023-09-08_18-17-22_hbrhac.csv'
one_calibrant_df = pd.read_csv(data_folder + 'nanodrop-spectrometer-measurements/reference_for_simple_SN1/'
                                             '2023-09-08_18-17-22_hbrhac.txt')
one_calibrant_df['nanodrop_col_name'] = one_calibrant_df['nanodrop_col_name'].astype(str)
one_calibrant_df = one_calibrant_df[one_calibrant_df['substance'] == 'HBRHAC']

ref_concentration=0.00894/dilution_factor
do_plot=True
