...
spectra = sp.load_all_spectra(craic_folder + '2023-03-27_20-06-51__plate0000003__pure-dmf-bkg-check/')
cut_from = 75
...
for i in range(nc):
    ...
    np.save(
        data_folder + f'simple-reactions/2023-07-05-run01/microspectrometer_data/background_model/component_{i}.npy',
        for_saving)
