...
exp_name_craic = 'multicomponent_0329_zoom_in'
true_sequence_of_plates = {17: 1,
                           18: 2,
                           11: 0}

df = pd.read_csv(craic_folder + 'database_about_these_folders.csv')
df = df.loc[df['exp_name'] == exp_name_craic].copy().reset_index()
...
for index, row in df.iterrows():
    ...
    id_of_range_of_conditions_for_this_plate = true_sequence_of_plates[row['plate_id']]
