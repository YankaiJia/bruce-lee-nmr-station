...
// Global variables
const solvent_peak_ppm_literature = 1.94;//Real peak ppm

const solvent_peak_search_from_ppm = 1.05;//Search range for DCE peak pick
const solvent_peak_search_to_ppm = 2.05;

const zoom_vert_lower = -0.5;
const zoom_vert_upper = 4;
const zoom_hor_lower = -2;
const zoom_hor_upper = 10;
...
//*****************************REFERENCING*******************************************//
    ...
    for (var i = 0; i < peaks.count; i++) {
		...
		if (delta >= solvent_peak_search_from_ppm && delta <= solvent_peak_search_to_ppm) {
    ...
    p.setParameter("ref[1].Shift", solvent_peak_ppm[0], solvent_peak_ppm_literature);
...
//*****************************************************************************//
	...
	//**********************ZOOM*****************************//		
	spec.vertZoom(zoom_vert_lower, zoom_vert_upper);	
	spec.horZoom(zoom_hor_lower, zoom_hor_upper);
	spec.update();
	//**********************************************************//
