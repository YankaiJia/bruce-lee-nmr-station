...
def fit_peaks(NMR_spectrum, std_deviation,
    ...
    if baseline_correction == True:
        try:
            ...
            print("\nBaseline could not be corrected, attempt with reduced window...")
            try:
...
def integrate_spectrum(file_name, is_save_plot=False, is_show_plot=False):
    ...
    for slice in tqdm.tqdm(NMR_slices):
...
if __name__ == "__main__":
    ...
    # ]
    ###Problematic samples
    file_list =[r"c:\Users\UNIST\Dropbox\brucelee\data\DPE_bromination\2025-03-12-run01_better_shimming\Results\ 43-1D EXTENDED+-20250313-211803\data.csv"]
    ###
    ...
    brucelee_path = 'C:/Users/UNIST/Dropbox/brucelee'
    master_path_ls = [
