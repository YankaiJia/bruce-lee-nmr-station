...
#     ]
###Problematic samples
file_list =[r"D:\Dropbox\brucelee\data\DPE_bromination\2025-03-12-run01_better_shimming\Results\ 43-1D EXTENDED+-20250313-211803\data.csv",
            # r"c:\Users\UNIST\Dropbox\brucelee\data\DPE_bromination\2025-03-12-run01_better_shimming\Results\ 8-1D EXTENDED+-20250313-161133\data.csv",
            # r"C:/Users/UNIST/Dropbox/brucelee\data\DPE_bromination\2025-03-12-run01_better_shimming\Results\ 30-1D EXTENDED+-20250313-191751\data.csv"
            ]
###
...
def integrate_spectrum(file_name):
    ...
    for slice in NMR_slices:
        ...
        for parameter in parameters:
            ...
            print(f"Peak at {parameter[0]} ppm, intensity {parameter[1]}, width {parameter[2]}\n")
            print(f"Closest Product:{closest_product}, Closest shift: {closest_shift}")
