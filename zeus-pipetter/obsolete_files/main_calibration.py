...
with open('../calibration_for_pipetting/event_list_calib_300ul.pickle', 'wb') as f:
...
# save the event list in pickle file and later load from this file
with open('../calibration_for_pipetting/event_list_calib_adjust_300ul.pickle', 'wb') as f:
    pickle.dump(calibration_event_list_adjust, f)
...
with open('../calibration_for_pipetting/weighing_result_300ul-0413-1500.json', 'w') as f:
