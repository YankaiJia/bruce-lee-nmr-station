...
def treat_one_file(xml_folder, xml_name):

    global df

    tree = ET.parse(xml_folder + xml_name)
    ...
    if xml_name == '2023_08_27_UV-Vis_reference.xml':
        aa = ['dioxane-1','dioxane-2',
              ...
              'sub3000x','sub2000x','sub1000x','sub800x','sub400x','sub200x','sub100x']
    ...
    assert len(uniques) == len(df.columns), "There is at least one duplicating column." \
