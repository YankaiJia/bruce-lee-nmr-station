...
## measured volume with 50ul tips on 03.26 and 03.27
'''
# target_volume,measured_mean,measured_std
8.0,8.51408163265306,0.25576550458595854
10.0,10.316530612244899,0.20170245837855244
12.0,12.46204081632653,0.2540205647454932
15.0,15.54326530612245,0.2815147638503575
20.0,20.69408163265306,0.2863059471560559
25.0,25.51428571428571,0.18919809292735168
30.0,30.466734693877548,0.24804861073211174
50.0,50.52428571428572,0.2502162330171768

# target_volume,measured_mean,measured_std
50.0,50.54408163265307,0.41565251562365585
30.0,30.64204081632653,0.24545650590931797
25.0,25.749591836734695,0.28856406768315906
20.0,20.741836734693877,0.23589753456496246
15.0,15.574285714285717,0.2812508503388506
12.0,12.528775510204081,0.33764268429419975
10.0,10.188775510204083,0.2246778433174952

'''

# based on the above measured volumes, the calibration parameters are changed to the following:
'''GEid0001gg22ck00102 00100 00197 00200 00296 00300 00487 00500 00734 00750 00980 01000 01972 02000 03018 03050'''
...
## with these values, I set liquidClassIndex_24 to the following parametes
"""
2023-03-20 21:30:10,306 - main.zeus.ZeusModule - INFO - liquid parameters: GMid0001lq24uu0 0 05000 0020 00030 00300 0200 010 0 3 3 0 0 05000 00000 000 00030 040 0200 010 0032567 00
2023-03-20 21:30:10,840 - main.zeus.ZeusModule - INFO - calibration_asp GEid0001gg24ck00076 00080 00101 00100 00119 00120 00147 00150 00192 00200 00243 00250 00296 00300 00492 00500 00
2023-03-20 21:30:11,373 - main.zeus.ZeusModule - INFO - calibration_disp GIid0001gh24cl00076 00080 00101 00100 00119 00120 00147 00150 00192 00200 00243 00250 00296 00300 00492 00500 00
2023-03-20 21:30:11,906 - main.zeus.ZeusModule - INFO - qpm_asp GSid0001gv24vv0100 0000 0015 0 0100 0000 0015 0 0100 0000 0015 0 0500 0000 0015 1 0693 0000 0015 1 0585 0000 0015 1 0502 0000 0015 1 0363 0000 0015 1 0000 0000 0000j誮
2023-03-20 21:30:12,440 - main.zeus.ZeusModule - INFO - qpm_asp GWid0001gp24ww0700 0000 1 0700 0000 1 0700 0000 1 0700 0000 1 0700 0000 1 0711 0000 1 0803 0000 1 0967 0000 1 0000 0000
"""
#the following volumes are obtained with the new parameters
"""
2023-03-20 21:35:25,064 - main - INFO - Result: {'DMF_50ul_49.0ul': {'weight': [44.69, 46.66, 45.79], 'volume': [47.34, 49.43, 48.51], 'liquid_class_index': [24, 24, 24], 'tip_type': ['50ul', '50ul', '50ul']}}
2023-03-20 21:36:45,978 - main - INFO - Result: {'DMF_50ul_30.0ul': {'weight': [29.3, 28.71, 28.74], 'volume': [31.04, 30.41, 30.44], 'liquid_class_index': [24, 24, 24], 'tip_type': ['50ul', '50ul', '50ul']}}
2023-03-20 21:38:06,581 - main - INFO - Result: {'DMF_50ul_25.0ul': {'weight': [23.8, 23.87, 23.59], 'volume': [25.21, 25.29, 24.99], 'liquid_class_index': [24, 24, 24], 'tip_type': ['50ul', '50ul', '50ul']}}
2023-03-20 21:39:27,196 - main - INFO - Result: {'DMF_50ul_20.0ul': {'weight': [18.7, 18.83, 19.1], 'volume': [19.81, 19.95, 20.23], 'liquid_class_index': [24, 24, 24], 'tip_type': ['50ul', '50ul', '50ul']}}
2023-03-20 21:40:47,785 - main - INFO - Result: {'DMF_50ul_15.0ul': {'weight': [14.56, 14.37, 14.46], 'volume': [15.42, 15.22, 15.32], 'liquid_class_index': [24, 24, 24], 'tip_type': ['50ul', '50ul', '50ul']}}
2023-03-20 21:42:08,417 - main - INFO - Result: {'DMF_50ul_12.0ul': {'weight': [11.72, 11.57, 11.39], 'volume': [12.42, 12.26, 12.07], 'liquid_class_index': [24, 24, 24], 'tip_type': ['50ul', '50ul', '50ul']}}
2023-03-20 21:43:28,985 - main - INFO - Result: {'DMF_50ul_10.0ul': {'weight': [9.57, 9.65, 9.24], 'volume': [10.14, 10.22, 9.79], 'liquid_class_index': [24, 24, 24], 'tip_type': ['50ul', '50ul', '50ul']}}
2023-03-20 21:44:49,673 - main - INFO - Result: {'DMF_50ul_8.0ul': {'weight': [8.3, 7.1, 8.23], 'volume': [8.79, 7.52, 8.72], 'liquid_class_index': [24, 24, 24], 'tip_type': ['50ul', '50ul', '50ul']}}
"""
